...
\item Zero width joiner Zero width non-joiner place holder glyphs - TODO explain 
in detail
...
It will also get broken if the font has  {\meera യ്ക്ക} but missed to add glyphs 
for {\meera യ്ക്കു യ്ക്കൂ }.
