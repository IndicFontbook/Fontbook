...
\begin{center}
\includegraphics[width=0.2\textwidth,height=0.2\textwidth,keepaspectratio]{JanaSanskritSans_ddhrya.png}

{\tiny The Devanagari ddhrya-ligature, as displayed in the JanaSanskritSans font.}
\end{center}
\end{wrapfigure}
